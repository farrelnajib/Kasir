...
$route['order/removePayment'] = 'order/removePayment';
$route['order/changePaymentMethod'] = 'order/changePaymentMethod';
$route['order/changePaymentAmount'] = 'order/changePaymentAmount';
$route['order/saveName'] = 'order/saveName';
$route['order/savePhone'] = 'order/savePhone';
